        ...
        <div class="flexVertical">
            <div class="flexHorizontal">
                ...
                <div>
                    ...
                    <div class="cokes">
                        ${repeatImgDivHtml('coke', 'coke', isCokeInDelivery)}
                    </div>
                </div>
            </div>
            ...
            <div class="flexVertical">
                ...
                <div class="flexHorizontal">
                    ...
                    <button ${cokesInStore <= 0 ? 'disabled' : ''} onclick="buyCoke()">Kjøpe cola</button>
                    <button ${isCokeInDelivery == 0 ? 'disabled' : ''} onclick="takeCoke()">Ta cola</button>
                </div>
            </div>
        </div>
    `;
